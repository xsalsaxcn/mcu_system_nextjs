      ...
      <div className="rounded-2xl border bg-white p-6 shadow-sm">
        ...
        <div className="mt-6 grid gap-5 xl:grid-cols-[1.15fr_0.85fr]">
          <section className="space-y-5">
            ...
            <div className="rounded-2xl border p-5">
              <h2 className="text-lg font-bold">3. Pilih Pemeriksaan yang Masuk PDF</h2>
              <p className="mt-1 text-sm text-slate-500">Halaman penunjang hanya dibuat bila dipilih dan data peserta tersedia.</p>
            ...
            <div className="rounded-2xl border p-5">
              ...
              <div className="mt-3 rounded-xl border border-amber-200 bg-amber-50 p-3 text-xs text-amber-900"><b>Format wajib:</b> <code>047-AGUS NUGROHO.jpg</code>. Untuk lampiran boleh <code>047-AGUS NUGROHO-THORAX.jpg</code>. Sistem menolak bila kode atau nama berbeda. <b>File tidak disimpan di Supabase Storage</b>; Supabase hanya menyimpan referensi Google Drive yang kecil agar gambar peserta dapat dipanggil saat PDF dibuat.</div>
            ...
            <div className="rounded-2xl border bg-slate-50 p-5">
              <h2 className="text-lg font-bold">6. Pengaturan Generate</h2>
              ...
              <button onClick={generatePdf} disabled={loading || !selectedIds.size || !sections.length} className="mt-4 w-full rounded-xl bg-emerald-600 px-5 py-3 text-sm font-bold text-white disabled:opacity-50">{loading ? "Generating PDF..." : `Generate PDF Corporate (${selectedIds.size} peserta)`}</button>
            </div>
          </section>
