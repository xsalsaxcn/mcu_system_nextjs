...
Write-Host "PATCH NUTRITION DIRECT GOOGLE SHEET V26"
Write-Host "Patch ini hanya menambah pembacaan Google Sheet untuk Meal Log / History."
Write-Host "Tidak mengubah input nutrisi, table, sync Google Fit, atau Health Connect."
...
Write-Host ""
Write-Host "OK - nutrition-direct now merges:"
Write-Host "  1. Supabase wellness_food_logs"
Write-Host "  2. Google Sheet CSV from GOOGLE_SHEET_NUTRITION_CSV_URL"
Write-Host "DONE - PATCH NUTRITION DIRECT GOOGLE SHEET V26"