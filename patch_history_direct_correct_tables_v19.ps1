...
$apiDir = Join-Path $project "app\api\wellness\portal\history-direct"
$apiPath = Join-Path $apiDir "route.ts"

Write-Host "PATCH HISTORY DIRECT CORRECT TABLES V19"
...
Write-Host "OK - history-direct route now uses:"
Write-Host "  wellness_food_logs"
Write-Host "  wellness_activity_logs"
Write-Host "  wellness_healthtalk_logs"
Write-Host "  wellness_checkup_history"
Write-Host "  wellness_integrations"
Write-Host "DONE - PATCH HISTORY DIRECT CORRECT TABLES V19"