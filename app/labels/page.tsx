  ...
  return (
    <div className="space-y-5">
      ...
      <section className="card p-5 no-print">
        <div className="text-2xl font-black">Cetak Label QR</div>
        <div className="mt-1 text-sm text-slate-500">
          Search dibuat ringan. QR berisi kombinasi Nomor MCU + Nama Lengkap.
        </div>
...
function LabelCard({
  ...
  const qrValue = buildCombinedQrValue(participant);
