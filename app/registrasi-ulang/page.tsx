        ...
        <section className="card p-5 no-print">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <div className="text-sm text-slate-500">
                Sama seperti fitur Cetak Label, tapi jumlah print bisa diatur per station/parameter. Isi 0 jika tidak perlu dicetak.
              </div>
            </div>
          ...
          <div className="mt-4 rounded-xl bg-blue-50 p-3 text-sm font-bold text-blue-700">
            Total label yang akan dicetak: {printJobs.length}. Klik Save dulu, lalu Print Barcode.
          </div>
        </section>
      )}
  ...
  return (
    <div
      ...
      style={{
        ...
        borderRadius: showBorder ? "1.5mm" : "0",
        overflow: "hidden",
    ...
    >
      <div
        ...
        style={{
          gridTemplateRows: "4.6mm 1fr 5.2mm",
          gap: "0.7mm"
        }}
      >
        <div
        ...
        <div className="grid min-h-0" style={{ gridTemplateColumns: showQr ? "1fr 12mm" : "1fr", gap: "1mm" }}>
          <div className="min-w-0">
            ...
            <div className="mt-[0.8mm] grid grid-cols-[14mm_1fr] gap-x-1" style={{ fontSize: `${fontSize}px`, lineHeight: 1.08 }}>
          ...
          {showQr && (
            <div className="flex items-start justify-end pt-[0.5mm]">
              <QRCodeImage value={idText} size={42} />
            </div>
          )}
        </div>
        ...
        <div
          ...
          style={{ gridTemplateColumns: "1fr 10mm", gap: "1mm" }}
        >
          <div className="min-w-0">
            {showBarcodeText ? (
              <div
