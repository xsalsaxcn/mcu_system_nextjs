        ...
        <section className="card p-5 no-print">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
            <div>
              ...
              <div className="text-sm text-slate-500">
                Jumlah print otomatis mengikuti setup paket. Layout v30 dibuat full 40x30, tanpa border, dan teks tidak tumpang tindih.
              </div>
            </div>
          ...
          <div className="mt-4 rounded-xl bg-blue-50 p-3 text-sm font-bold text-blue-700">
            Total label yang akan dicetak: {printJobs.length}. Layout print v30: full 40x30, no border, font compact.
          </div>
        </section>
      )}
